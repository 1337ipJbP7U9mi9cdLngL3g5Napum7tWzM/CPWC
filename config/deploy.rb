...
set :ssh_options,     { forward_agent: true, user: fetch(:user), keys: %w(~/.ssh/id_rsa_1337) }
set :puma_preload_app, true
set :puma_worker_timeout, nil
set :puma_init_active_record, true  # Change to true if using ActiveRecord

set :nginx_use_ssl, true
set :nginx_server_name, "cryptocurrencieschecker.com www.cryptocurrencieschecker.com"
set :nginx_ssl_certificate, "/etc/letsencrypt/live/cryptocurrencieschecker.com/fullchain.pem"
set :nginx_ssl_certificate_key, "/etc/letsencrypt/live/cryptocurrencieschecker.com/privkey.pem"
